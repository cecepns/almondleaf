...
const GoogleTranslate = ({ closeOnComplete = true, onComplete, isScrolled } = {}) => {
    ...
    <div className="relative notranslate" translate="no">
      ...
      <div className="relative notranslate" translate="no">
        <button
          ...
          className={`flex space-x-1 items-center space-x-2 md:px-3 md:py-2 rounded-md text-sm font-medium transition-colors ${
            isLoaded && !isTranslating ? (isScrolled ? "text-gray-700" : "text-white") : "text-gray-400 cursor-not-allowed"
          }`}
      ...
      {isTranslating && (
        <div className="absolute -top-1 md:top-7 right-0 mt-1 text-xs text-gray-800 select-none">
          Translating...
        </div>
      )}
    </div>
